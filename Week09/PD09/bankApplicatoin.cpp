// CRUD Function is implemented as Admin, login as admin with credentials username = "admin" password = "1234"
// press 4 for Retrieve Data
// press 5 for detete user
// press 1 to create account
// press 6 to update password also to add or subtract money, press 2
// for reference, use email = first@UET.com
#include<iostream>
#include<cmath>
#include<iomanip>
#include<conio.h>
