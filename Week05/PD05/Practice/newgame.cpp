    ...
    for (int i = 0; i < 5; ++i) {
        if (playerDirection == 'R') {
            if (((pX + 4 == guardPositionsX[i] || pX + 4 == guardPositionsX[i] + 1 || 
                ...
                gameScore += 10;
                guardHealths[i] -= 10;  // Decrease health of corresponding guard
                impact(guardPositionsX[i], guardPositionsY[i]);  // Impact on current guard
            }
        }
...
void score(){
    ...
    gotoxy(200,21);
    cout<<"Guard 1 Health: " << guardHealth<<endl;
    gotoxy(200,22);
    cout<<"Guard 2 Health: " << guard2Health<<endl;
    gotoxy(200,23);
    cout<<"Guard 3 Health: " << guard3Health<<endl;
    gotoxy(200,24);
    cout<<"Guard 4 Health: " << guard4Health<<endl;
    gotoxy(200,25);
    cout<<"Guard 5 Health: " << guard5Health<<endl;
}
